...
;
        boolean emailCorrect = false;//inicia en falso q hasta que haga verifi
         do {
            ...
            do {
                ...
                switch (response){
                    case 1:
                        ...
                        for (int i = 1; i<4;i++ ){//muestra los 3 primeros meses
...
//SWITC = OPCIONES
//NOTA = STATIC = que ls variables esten siempre disponible
//NOTA: STATIC = DA UN SCOT GLOBAL DE LA VARIABLE y da un nivel superior